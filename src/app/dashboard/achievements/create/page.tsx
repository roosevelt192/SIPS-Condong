...
export default function AchievementsPage() {
  ...
  // ===========================================================================
  // 7. INDIVIDUAL TRACKING & CETAK RAPOR PRESTASI
  // ===========================================================================
    ...
    <div className="space-y-5 max-w-7xl mx-auto font-sans relative pb-24">
      ...
      <div className="relative overflow-hidden rounded-3xl border border-slate-200/80 dark:border-slate-800/80 bg-white/90 dark:bg-slate-900/90 p-5 sm:p-6 shadow-sm backdrop-blur-xl print:hidden">
        <div className="flex flex-col xl:flex-row xl:items-center xl:justify-between gap-4">
          {/* Sisi Kiri: Ikon, Judul & Deskripsi Lengkap */}
          ...
          <div className="flex items-center gap-2 flex-wrap sm:flex-nowrap self-end xl:self-center shrink-0">
            <button
              type="button"
              onClick={fetchData}
              className="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 text-slate-600 dark:text-slate-300 shadow-xs transition hover:border-emerald-500/50 hover:text-emerald-500 active:scale-95"
              title="Segarkan Data"
            >
            ...
            <button
              ...
              className="inline-flex items-center space-x-1.5 rounded-xl border border-emerald-600/30 bg-emerald-500/10 hover:bg-emerald-500/20 text-emerald-700 dark:text-emerald-400 px-3.5 py-2 text-xs font-bold transition active:scale-95 shadow-xs whitespace-nowrap"
            ...
            <button
              ...
              className="inline-flex items-center space-x-1.5 rounded-xl border border-slate-300 dark:border-slate-700 bg-slate-100 hover:bg-slate-200 dark:bg-slate-800 dark:hover:bg-slate-700 px-3.5 py-2 text-xs font-bold text-slate-700 dark:text-slate-200 transition active:scale-95 shadow-xs whitespace-nowrap"
            ...
            <Link
              ...
              className="inline-flex items-center space-x-1.5 rounded-xl bg-gradient-to-r from-emerald-600 via-teal-500 to-amber-500 hover:from-emerald-500 hover:to-amber-400 px-4 py-2 text-xs font-black text-white shadow-md shadow-emerald-500/20 transition active:scale-95 whitespace-nowrap"
            >
                        ...
                        <div className="flex items-center space-x-3">
                          ...
                          <div>
                            <button
                              ...
                              className="font-bold text-slate-900 dark:text-white text-sm group-hover:text-emerald-600 dark:group-hover:text-emerald-400 transition-colors hover:underline text-left"
                      ...
                      <td className="py-3.5 px-4 text-right">
                        <div className="flex items-center justify-end space-x-1">
                          <button
                            type="button"
                            onClick={() => handleOpenStudentDossier(a)}
                            className="p-2 rounded-xl border border-slate-200 dark:border-slate-800 text-slate-500 dark:text-slate-400 hover:text-cyan-500 hover:border-cyan-500/40 hover:bg-cyan-500/10 transition active:scale-90"
                          ...
                          <button
                            ...
                            className="p-2 rounded-xl border border-slate-200 dark:border-slate-800 text-slate-500 dark:text-slate-400 hover:text-amber-500 hover:border-amber-500/40 hover:bg-amber-500/10 transition active:scale-90"
                          ...
                          <button
                            ...
                            className="p-2 rounded-xl border border-slate-200 dark:border-slate-800 text-slate-500 dark:text-slate-400 hover:text-rose-500 hover:border-rose-500/40 hover:bg-rose-500/10 transition active:scale-90"
        ...
        <div className="fixed bottom-6 left-1/2 -translate-x-1/2 z-40 w-[90%] max-w-2xl bg-slate-900/95 border border-slate-800 text-white px-5 py-3.5 rounded-3xl shadow-2xl backdrop-blur-xl flex items-center justify-between gap-4 animate-in slide-in-from-bottom-5 duration-200 print:hidden">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="inline-flex items-center space-x-1.5 rounded-xl bg-rose-600/20 text-rose-300 border border-rose-600/30 hover:bg-rose-600/30 px-3.5 py-2 text-xs font-bold transition active:scale-95"
            >
          ...
          <div className="w-full max-w-3xl my-auto overflow-hidden rounded-[32px] border border-slate-800 bg-slate-900 text-white space-y-5 p-6 sm:p-8 shadow-2xl animate-in zoom-in-95">
              ...
              <div className="flex items-center overflow-x-auto gap-1 bg-slate-950 p-1 rounded-xl border border-slate-800 text-xs font-bold">
                {[
                  ...
                  <button
                    ...
                    className={`px-3 py-1 rounded-lg transition text-[11px] whitespace-nowrap ${
            ...
            <div className="flex items-center justify-between pt-3 border-t border-slate-800 gap-2">
              <button
                ...
                className="inline-flex items-center space-x-2 px-4 py-2.5 rounded-xl bg-amber-500 hover:bg-amber-400 text-slate-950 font-black text-xs transition active:scale-95 disabled:opacity-40"
              >
          ...
          <div className="w-full max-w-sm rounded-3xl border border-slate-800 bg-slate-900 p-6 text-white space-y-4 shadow-2xl animate-in zoom-in-95">
            ...
            <div className="flex gap-2 pt-1">
              ...
              <button
                ...
                disabled={isBatchDeleting}
                className="flex-1 py-2.5 rounded-xl bg-rose-600 hover:bg-rose-500 text-white font-bold text-xs shadow-md transition disabled:opacity-50 flex items-center justify-center space-x-1.5"
              >
          ...
          <div className="w-full max-w-md overflow-hidden rounded-[28px] border border-slate-800 bg-slate-900/95 p-6 text-white space-y-5 shadow-2xl animate-in zoom-in-95 duration-150">
            <div className="flex items-start justify-between">
              ...
              <button
                ...
                className="text-slate-400 hover:text-white rounded-xl p-1 hover:bg-slate-800 transition"
              >
                <X className="h-4 w-4" />
              </button>
            </div>
            ...
            <div className="flex items-center gap-3 pt-1">
              <button
                ...
                onClick={() => setItemToDelete(null)}
                disabled={isDeleting}
                className="flex-1 rounded-xl border border-slate-700 bg-slate-800/80 hover:bg-slate-800 py-3 text-xs font-bold text-slate-300 transition"
              >
                Batal
              </button>
              <button
                ...
                disabled={isDeleting}
                className="flex-1 inline-flex items-center justify-center space-x-1.5 rounded-xl bg-rose-600 hover:bg-rose-500 py-3 text-xs font-black text-white shadow-lg shadow-rose-600/30 transition disabled:opacity-50"
              >
            ...
            <form onSubmit={handleSaveEdit} className="space-y-3.5 text-xs font-sans">
              ...
              <div className="flex gap-2.5 pt-2 border-t border-slate-800">
                <button
                  type="button"
                  onClick={() => setEditingItem(null)}
                  className="flex-1 py-2.5 rounded-xl border border-slate-700 bg-slate-800 text-slate-300 font-bold hover:bg-slate-700 transition"
                >
                  Batal
                </button>
                <button
                  type="submit"
                  disabled={isUpdating}
                  className="flex-1 py-2.5 rounded-xl bg-amber-500 hover:bg-amber-400 text-slate-950 font-black shadow-md transition flex items-center justify-center space-x-1.5"
                >
